...
public class JdbcRestaurantRepository implements RestaurantRepository {
	...
	// had to add maven repo to use this annotation https://mvnrepository.com/artifact/javax.annotation/javax.annotation-api
	// I read that it is deprecated in java 9 and was removed in java 11 hence we have to add it manually
	@PostConstruct
